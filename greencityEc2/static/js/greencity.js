//const jsPath = "./../static/"
const jsPath = "http://carolsun.top/210/srv/static/"
...
function updatePolygonStyle() {
   ...
   //document.getElementById("loading").textContent = "Calculating...";
    ...
    layers.forEach(layer => {
        ...
        activeModels.forEach(model => {
            ...
            /*
            const modelFeatures = modelData[model].densityMap;
            ...
            if (matchingFeature && typeof matchingFeature.properties.density === "number") {
                ...
                */
            const densityMap = modelData[model]?.densityMap;

            if (densityMap && typeof densityMap[objectId] === "number") {
...
function loadModelScript(modelKey) {
    ...
    return new Promise((resolve, reject) => {
        ...
        script.src = jsPath + `js/${modelKey}.js`; // your file should be named like cv60cm.js etc.
        script.onload = () => {
            try {
